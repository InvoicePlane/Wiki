...
<div class="table-responsive">
    <table class="table table-condensed table-striped">
        ...
        <tr>
            ...
            <td>Choose the currency symbol like <code>&euro;</code> or <code>&dollar;</code>. You can also use any letters like <code>AUD</code> or <code>CHF</code></td>
        </tr>
        <tr>
...
<div class="table-responsive">
    <table class="table table-condensed table-striped">
        ...
        <tr>
            ...
            <td>Choose if the application should use a monospace font for amounts.<br/>Example: <code style="font-family: monospace">1.345,23 &euro;</code></td>
        </tr>
        <tr>
            <td>Login Logo</td>
            <td>Upload an image that will be displayed above the login form.<br/><small>Recommended size: about 300px width</small></td>
        </tr>
        <tr>
            <td>Cron Key</td>
            <td>You will need this cron key to setup <a href="/en/1.0/modules/recurring-invoices">recurring invoices</a>.</td>
        </tr>
    </table>
</div>
