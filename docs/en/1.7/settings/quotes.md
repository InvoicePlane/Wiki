...
[![](https://invoiceplane.com/content/screenshots/web_thumb/ip_settings_quotes.jpg)](https://invoiceplane.com/content/screenshots/web/ip_settings_quotes.jpg)
...
| Default Quotegroup | Select the [Quotegroup (aka Invoicegroups)](/en/1.7/settings/invoicegroups) that should be used by default |
