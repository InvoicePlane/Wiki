...
[![](https://invoiceplane.com/content/screenshots/web_thumb/ip_clients.jpg)](https://invoiceplane.com/content/screenshots/web/ip_clients.jpg)
...
[![](https://invoiceplane.com/content/screenshots/web_thumb/ip_clients_add.jpg)](https://invoiceplane.com/content/screenshots/web/ip_clients_add.jpg)
...
[custom fields](/en/1.7/settings/custom-fields) created for client records will display at the bottom
of the client form.

## Client Logins

Clients can be granted permission to log into InvoicePlane to view their quotes and invoices, approve or reject
quotes and pay their invoices. See the `Guest Account` section of the [User Accounts](/en/1.7/settings/user-accounts) page for instructions on creating logins for
your clients.
