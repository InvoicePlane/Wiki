...
More information about available settings can be found on the [Settings](/en/1.6/modules/settings)
page.
...
More information about the client management can be found on the [Clients](/en/1.6/modules/clients)
page.
...
More information about products can be found on the [Products](/en/1.6/modules/products)
page.
...
More information about payments can be found on the [Payments](/en/1.6/modules/payments)
page.
