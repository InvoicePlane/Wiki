...
InvoicePlane 1.6 supports only **Stripe** by default as a payment gateway. The reason why the other providers were dropped can be found [here](/en/1.6/getting-started/updating-ip#16-breaking-changes). Please let us know what payment method you are missing at [GitHub](https://github.com/InvoicePlane/InvoicePlane/issues)
