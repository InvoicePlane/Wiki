        ...
        <div id="debugmode" class="card">
            ...
            <div class="card-block">
                ...
                <ol>
                    ...
                    <li>Save the content on the logs and the output of the browser console to <a href="https://paste.invoiceplane.com/">Paste.InvoicePlane.com</a> and post this link with a detailed description to the <a href="https://community.invoiceplane.com">Community Forums</a>.<br/>You will get further help there.</li>
                </ol>
            </div>
        </div>
