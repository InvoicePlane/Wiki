...
@section('content')
    ...
    <h3 id="types">
        User Types <?php IP::headlineLink('/en/1.5/settings/user_accounts#types'); ?>
    </h3>
    ...
    ###
    <h3 id="view">
        Viewing Users <?php IP::headlineLink('/en/1.5/settings/user_accounts#view'); ?>
    </h3>
    ...
    <h3 id="add">
        Add an User Account <?php IP::headlineLink('/en/1.5/settings/user_accounts#add'); ?>
    </h3>
