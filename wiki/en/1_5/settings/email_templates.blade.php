...
@section('content')
    ...
    <h3 id="add">
        Creating an Email Template <?php IP::headlineLink('/en/1.5/settings/email-templates#add'); ?>
    </h3>
    ...
    <h3 id="default-templates">
        Setting Default Email Templates <?php IP::headlineLink('/en/1.5/settings/email-templates#default-templates'); ?>
    </h3>
