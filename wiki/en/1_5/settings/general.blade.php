...
@section('content')
    ...
    <h3 id="dashboard">
        Dashboard settings <?php IP::headlineLink('/en/1.5/settings/general#dashboard'); ?>
    </h3>
    ...
    <h3 id="interface">
        Interface settings <?php IP::headlineLink('/en/1.5/settings/general#interface'); ?>
    </h3>
    ...
    <h3 id="interface">
        System settings <?php IP::headlineLink('/en/1.5/settings/general#system'); ?>
    </h3>
