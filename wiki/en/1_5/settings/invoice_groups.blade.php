...
@section('content')
    ...
    <h3 id="configure">
        Configure an Invoice Group <?php IP::headlineLink('/en/1.5/settings/invoice-groups#configure'); ?>
    </h3>
    ...
    <h4 id="prefix">
        Format the Identifier <?php IP::headlineLink('/en/1.5/settings/invoice-groups#identifier'); ?>
    </h4>
    ...
    <h4 id="examples">
        Formatting Examples <?php IP::headlineLink('/en/1.5/settings/invoice-groups#examples'); ?>
    </h4>
