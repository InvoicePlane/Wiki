...
@section('content')
    ...
    <p>More information about available settings can be found on the <a href="{{ url('en/1.5/modules/settings') }}">Settings</a>
        page.</p>
    ...
    <p>More information about the client management can be found on the <a href="{{ url('en/1.5/modules/clients') }}">Clients</a>
        page.</p>
    ...
    <p>More information about products can be found on the <a href="{{ url('en/1.5/modules/products') }}">Products</a> page.</p>
    ...
    <p>If you added some products before you can simply add them via the <code>Add Product</code> button left from the
    ...
    <p>More information about payments can be found on the <a href="{{ url('en/1.5/modules/payments') }}">Payments</a> page.</p>
