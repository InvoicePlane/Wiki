...
@section('content')
    ...
    <h3>Upgrade to InvoicePlane 1.5.0 from a previous version</h3>
    ...
    <ol>
        <li>The most important change: InvoicePlane now uses a new configuration file that is completely independent from the code itself. This means you set the configuration file once and you will never have to worry about overwriting some important settings. To migrate the configuration, follow these steps:
            <ul>
                ...
                <li>Open the <code>application/config/database.php</code> file and copy your database credentials to a text file or note them somewhere else.</li>
        ...
        <li>Now delete all files within the InvoicePlane directory as many files and folders are now deprecated. Leaving all old files where they are may lead to problems! The setup will not clean up old files on his own.</li>
