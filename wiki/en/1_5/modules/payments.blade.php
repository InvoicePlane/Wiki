...
@section('content')
    ...
    <h3 id="view">
        View Payments <?php IP::headlineLink('/en/1.5/modules/payments#view'); ?>
    </h3>
    ...
    <h3 id="add">
        Entering a Payment <?php IP::headlineLink('/en/1.5/modules/payments#add'); ?>
    </h3>
    ...
    <h3 id="online">
        Online Payments <?php IP::headlineLink('/en/1.5/modules/payments#online'); ?>
    </h3>
    ...
    <h4 id="paypal">
        Configure PayPal for Online Payments <?php IP::headlineLink('/en/1.5/modules/payments#paypal'); ?>
    </h4>
