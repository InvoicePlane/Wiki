...
@section('content')
    ...
    <h3 id="lifecycle">
        The Invoice Lifecycle <?php IP::headlineLink('/en/1.5/modules/invoices#lifecycle'); ?>
    </h3>
    ...
    <h3 id="view">
        Viewing Invoices <?php IP::headlineLink('/en/1.5/modules/quotes#view-quote'); ?>
    </h3>
    ...
    <h3 id="add">
        Creating an Invoice <?php IP::headlineLink('/en/1.5/modules/invoices#add'); ?>
    </h3>
    ...
    <p class="small">* Invoice deletion is not available for all invoices. Please read the information for <a href="{{ url('en/1.5/modules/invoices#delete') }}">invoice deletion</a>.</p>

    <h4 id="add-products">
        Add Products <?php IP::headlineLink('/en/1.5/modules/invoices#add-products'); ?>
    </h4>
    ...
    <h4 id="item-order">
        Changing Item Order <?php IP::headlineLink('/en/1.5/modules/invoices#item-order'); ?>
    </h4>
    ...
    <h4 id="discounts">
        Discounts <?php IP::headlineLink('/en/1.5/modules/invoices#discounts'); ?>
    </h4>
    ...
    <h4 id="add-tax">
        Adding Tax <?php IP::headlineLink('/en/1.5/modules/invoices#add-tax'); ?>
    </h4>
    ...
    <h4 id="copy">
        Copying an Invoice <?php IP::headlineLink('/en/1.5/modules/invoices#copy'); ?>
    </h4>
    ...
    <h3 id="delete">
        Invoice Deletion <?php IP::headlineLink('/en/1.5/modules/invoices#delete'); ?>
    </h3>
    ...
    <h3 id="read-only">
        Read-only <?php IP::headlineLink('/en/1.5/modules/invoices#read-only'); ?>
    </h3>
