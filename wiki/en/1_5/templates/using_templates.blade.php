...
@section('content')
    ...
    <p>You can select which templates should be used in the system settings for either <a href="{{ url('en/1.5/settings/invoices') }}">Invoices</a> or <a href="{{ url('en/1.5/settings/quotes') }}">Quotes</a>. You can find the select boxes below the headline "Templates". Simply select the template, save and the template will be used for the next quote or invoice.</p>
    ...
    $article_pagination = array(
            ...
            'next' => array(
                    'url' => '/en/1.5/templates/customize-templates',
