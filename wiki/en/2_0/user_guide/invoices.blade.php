...
@section('content')
    ...
    <ul>
        <li><a href="#create-invoice">How do I create an invoice?</a></li>
        <li><a href="#email-invoice">How do I email an invoice?</a></li>
        <li><a href="#enter-payment">How do I enter a payment?</a></li>
        <li><a href="#copy-invoice">How do I copy an invoice?</a></li>
        <li><a href="#attach-files-invoice">How do I attach files to an invoice?</a></li>
    </ul>
    ...
    <a href="/content/docs/2.0/invoice_create.png" target="_blank">
        <img src="/content/docs/2.0/invoice_create_small.png" class="img-responsive">
    </a>

    <p>The Create Invoice screen will prompt you for the client name, invoice date, company profile and
        group.</p>
    ...
    <a href="/content/docs/2.0/invoice_create2.png" target="_blank">
        <img src="/content/docs/2.0/invoice_create2_small.png" class="img-responsive">
    </a>
    ...
    <p>The from and to areas display who the invoice is issued from and who the invoice is being sent to. If you
        ...
        invoice
        with the wrong client selected, you can easily correct that by pressing the Change button on the To area
        and choose
    ...
    <p>Terms and conditions as well as text to appear in the footer of your invoice may be entered on the
        Additional tab. Defaults
        for these fields may be set in System Settings on the Invoices tab (default values for these fields will
        not appear on invoices
        already created).</p>
    <p>Public or private notes may be entered on the Notes tab. Notes entered on this tab will be visible to
        clients viewing
        the invoice using the public link unless they are marked as private. Clients may leave notes on an
        invoice when viewing
        the invoice using the public link as well.</p>
    <p>File attachments may be uploaded to an invoice on the Attachments tab. See <a
                href="#attach-files-invoice">How do I attach files
    ...
    <ul>
        ...
        <li>Currency - The currency the invoice will be issued and paid in. The default currency can be changed
            on both the client
            record and in System Settings. If the client record has a different currency than System Settings,
            the currency on the client
        ...
        <li>Status - The current status of the invoice. Once an invoice has been emailed, the status will
            automatically update
            itself to Sent. Once an invoice has been paid in full, the status will automatically update itself
            to Paid. If you have printed
        ...
        <li>Template - This is the template the invoice will use when viewed using the public link or when
            ...
            default template can be changed on both the client record and in System Settings. If the client
            record has a different default template
            than System Settings, the client record will override System Settings. This behavior allows you use
            a specific template as default
            for most of your invoices while specifying a different template for a particular client or clients.
        </li>
    </ul>

    <a href="/content/docs/2.0/invoice_edit.png" target="_blank">
        <img src="/content/docs/2.0/invoice_edit_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/invoice_email.png" target="_blank">
        <img src="/content/docs/2.0/invoice_email_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/invoice_email2.png" target="_blank">
        <img src="/content/docs/2.0/invoice_email2_small.png" class="img-responsive">
    </a>
    ...
    <p>Payments collected manually can be entered against an invoice from the Invoice Edit screen by pressing
        the Other
        button and choosing Enter Payment.</p>

    <a href="/content/docs/2.0/invoice_enter_payment.png" target="_blank">
        <img src="/content/docs/2.0/invoice_enter_payment_small.png" class="img-responsive">
    </a>

    <p>If the invoice is being paid in full, the amount field will already contain the full balance amount so
        you won't have to
    ...
    <p>If you'd like to email the client with an email receipt of payment, check the Email Payment Receipt
        box.</p>
    <p>Press the Submit button and the payment will be submitted to the invoice.</p>

    <a href="/content/docs/2.0/invoice_enter_payment2.png" target="_blank">
        <img src="/content/docs/2.0/invoice_enter_payment2_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/invoice_copy.png" target="_blank">
        <img src="/content/docs/2.0/invoice_copy_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/invoice_copy2.png" target="_blank">
        <img src="/content/docs/2.0/invoice_copy2_small.png" class="img-responsive">
    </a>
    ...
    <ul>
        ...
        <li>Visible After Payment - Clients will be able to access this attachment from the invoice public link
            only after the invoice
            has been paid in full.
        </li>
    </ul>

    <p style="font-style: italic;">* Note that attachments uploaded to an invoice do not "attach" themselves to
        the invoice
        PDF output. Invoice attachments are intended to provide an easy way to deliver digital assets related to
        an invoice
        to your clients (or just to store related files for your own purposes).</p>

    <a href="/content/docs/2.0/invoice_attachments.png" target="_blank">
        <img src="/content/docs/2.0/invoice_attachments_small.png" class="img-responsive">
    </a>
