...
@section('content')
    ...
    <ul>
        <li><a href="#create-quote">How do I create a quote?</a></li>
        <li><a href="#email-quote">How do I email a quote?</a></li>
        <li><a href="#convert-to-invoice">How do I convert a quote to an invoice?</a></li>
        <li><a href="#copy-quote">How do I copy a quote?</a></li>
        <li><a href="#attach-files-quote">How do I attach files to a quote?</a></li>
    </ul>
    ...
    <a href="/content/docs/2.0/quote_create.png" target="_blank">
        <img src="/content/docs/2.0/quote_create_small.png" class="img-responsive">
    </a>

    <p>The Create Quote screen will prompt you for the client name, quote date, company profile and group.</p>
    <p>If the quote is for a new client, type the client's name in full. You will be able to edit the other
        details
    ...
    <p>The company profile is where the quote will pull your company name, address, phone number, and other
        company
    ...
    <a href="/content/docs/2.0/quote_create2.png" target="_blank">
        <img src="/content/docs/2.0/quote_create2_small.png" class="img-responsive">
    </a>
    ...
    <p>Entering a brief summary or description of the quote will make the quote easier to find and search
        for.</p>
    ...
    <p>The from and to areas display who the quote is issued from and who the quote is being sent to. If you
        created the quote with the wrong company profile selected by mistake, you can easily change that by
        pressing
    ...
    <p>Terms and conditions as well as text to appear in the footer of your quote may be entered on the
        Additional tab. Defaults
        for these fields may be set in System Settings on the Quotes tab (default values for these fields will
        not appear on quotes
        already created).</p>
    <p>Public or private notes may be entered on the Notes tab. Notes entered on this tab will be visible to
        clients viewing
        the quote using the public link unless they are marked as private. Clients may leave notes on a quote
        when viewing
        the quote using the public link as well.</p>
    <p>File attachments may be uploaded to a quote on the Attachments tab. See <a href="#attach-files-quote">How
            do I attach files
    ...
    <ul>
        ...
        <li>Status - The current status of the quote. Once a quote has been emailed, the status will
            automatically update itself to Sent. If
            a client has accepted or rejected a quote from the public quote link, it will update itself to the
            appropriate status.
        </li>
        <li>Template - This is the template the quote will use when viewed using the public link or when
            generating the quote PDF. The
    ...
    <a href="/content/docs/2.0/quote_edit.png" target="_blank">
        <img src="/content/docs/2.0/quote_edit_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/quote_email.png" target="_blank">
        <img src="/content/docs/2.0/quote_email_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/quote_email2.png" target="_blank">
        <img src="/content/docs/2.0/quote_email2_small.png" class="img-responsive">
    </a>
    ...
    <p>Once a client has accepted your quote, you can convert it to an invoice on the Quote Edit screen by
        clicking
        the Options button and choosing Quote to Invoice.</p>

    <a href="/content/docs/2.0/quote_to_invoice.png" target="_blank">
        <img src="/content/docs/2.0/quote_to_invoice_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/quote_to_invoice2.png" target="_blank">
        <img src="/content/docs/2.0/quote_to_invoice2_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/quote_copy.png" target="_blank">
        <img src="/content/docs/2.0/quote_copy_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/quote_copy2.png" target="_blank">
        <img src="/content/docs/2.0/quote_copy2_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/quote_attachments.png" target="_blank">
        <img src="/content/docs/2.0/quote_attachments_small.png" class="img-responsive">
    </a>
