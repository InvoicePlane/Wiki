...
@section('content')
    ...
    <ul>
        ...
        <li><a href="#online-payments">How do I enable online payments?</a></li>
        <li><a href="#paypal-rest-api-keys">How do I get my PayPal REST API keys?</a></li>
        <li><a href="#client-online-payments">How does my client pay their invoice online?</a></li>
    </ul>
    ...
    <p>See <a href="{{ url('en/2.0/user-guide/invoices#enter-payment') }}">How do I enter a payment?</a> in the Invoices user guide.</p>
    ...
    <p>To configure InvoicePlane for online payments, click the System icon and select System Settings.</p>

    <a href="/content/docs/2.0/system_settings.png" target="_blank">
        <img src="/content/docs/2.0/system_settings_small.png" class="img-responsive">
    </a>

    <p>Each of the different payment gateways that are compatible with InvoicePlane are listed on the
    ...
    <ul>
        <li>PayPal
            <ul>
                ...
                <li>Signature - Enter the Signature found in the same area as the API Username & API Password.
                </li>
    ...
    <a href="/content/docs/2.0/system_settings_online_payments.png" target="_blank">
        <img src="/content/docs/2.0/system_settings_online_payments_small.png"
    ...
    <p>Prior to version 2018-7, InvoicePlane used PayPal's classic NVP/SOAP api. Version 2018-7 and later use
        PayPal's REST api.</p>

    <p>Log into the <a href="https://developer.paypal.com/developer/applications/">PayPal Developer</a> portal
        using your standard PayPal credentials.</p>

    <p>Click the Create App button in the REST API apps section of the My Apps & Credentials page.</p>
    <a href="/content/docs/2.0/online_payments_paypal_rest1.png" target="_blank">
        <img src="/content/docs/2.0/online_payments_paypal_rest1_small.png" class="img-responsive">
    </a>

    <p>Give the app a name, such as InvoicePlane (or whatever you'd like) and click the Create App button.</p>
    <a href="/content/docs/2.0/online_payments_paypal_rest2.png" target="_blank">
        <img src="/content/docs/2.0/online_payments_paypal_rest2_small.png" class="img-responsive">
    </a>

    <p>Once the app is created, the Client ID and Secret ID can be obtained. Note there is an option to switch
        between
        the keys for Sandbox and Live. Be sure and use Sandbox for testing purposes and Live for production.
        Also note the
        Secret ID spans two lines, so be sure the entire key gets copied. Configure the keys in InvoicePlane on
        the Online Payments
        tab in System Settings.</p>
    <a href="/content/docs/2.0/online_payments_paypal_rest3.png" target="_blank">
        <img src="/content/docs/2.0/online_payments_paypal_rest3_small.png" class="img-responsive">
    </a>
    ...
    <p>Once you have InvoicePlane configured to accept online payments, clients may pay their invoices using
        the invoice public link.</p>
    <p>When an invoice is emailed to the client, the email will contain a link to view and pay the invoice
        online. This is the
    ...
    <a href="/content/docs/2.0/payment_online.png" target="_blank">
        <img src="/content/docs/2.0/payment_online_small.png"
             class="img-responsive">
    </a>
