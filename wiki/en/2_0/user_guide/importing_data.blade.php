...
@section('content')
    ...
    <p>Optional columns: unique_name, address, city, state, zip, country, phone, fax, mobile, email, web, any
        custom client fields</p>
    ...
    <ul>
        ...
        <li>The company_profile column should contain the name of the company profile to attach the record to.
        </li>
        <li>
    ...
    <ol>
        ...
        <li>Choose the type of records to import, select the file to be imported and press the Submit button.
        </li>
