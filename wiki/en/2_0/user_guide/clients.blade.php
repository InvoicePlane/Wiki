...
@section('content')
    ...
    <ul>
        <li><a href="#add-client">How do I add a client?</a></li>
        <li><a href="#multiple-contacts">How do I add multiple contacts to my clients?</a></li>
        <li><a href="#create-logins">How do I create logins for my clients?</a></li>
        <li><a href="#change-localization">How do I change localization settings for a specific client?</a></li>
    </ul>
    ...
    <a href="/content/docs/2.0/client_create.png" target="_blank">
        <img src="/content/docs/2.0/client_create_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/client_create2.png" target="_blank">
        <img src="/content/docs/2.0/client_create2_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/client_contact1.png" target="_blank">
        <img src="/content/docs/2.0/client_contact1_small.png" class="img-responsive">
    </a>

    <p>Enter the name and email address for the new contact and press the Save button.</p>

    <a href="/content/docs/2.0/client_contact2.png" target="_blank">
        <img src="/content/docs/2.0/client_contact2_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/client_contact3.png" target="_blank">
        <img src="/content/docs/2.0/client_contact3_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/client_contact4.png" target="_blank">
        <img src="/content/docs/2.0/client_contact4_small.png" class="img-responsive">
    </a>
    ...
    <p>InvoicePlane provides a limited access client login feature called Client Center. The Client Center
        allows clients
    ...
    <a href="/content/docs/2.0/user_account_client1.png" target="_blank">
        <img src="/content/docs/2.0/user_account_client1_small.png" class="img-responsive">
    </a>

    <p>To create a client user account, click the New button and then choose Client Account. </p>
    <a href="/content/docs/2.0/user_account_client2.png" target="_blank">
        <img src="/content/docs/2.0/user_account_client2_small.png" class="img-responsive">
    </a>
    ...
    <p style="font-style: italic;">* Note: If a client isn't listed in the dropdown, it's because a) they
        ...
        set
        to inactive.</p>
    <a href="/content/docs/2.0/user_account_client3.png" target="_blank">
        <img src="/content/docs/2.0/user_account_client3_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/user_account_client4.png" target="_blank">
        <img src="/content/docs/2.0/user_account_client4_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/client_edit.png" target="_blank">
        <img src="/content/docs/2.0/client_edit_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/client_localization.png" target="_blank">
        <img src="/content/docs/2.0/client_localization_small.png" class="img-responsive">
    </a>
