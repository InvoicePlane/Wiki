...
@section('content')
    ...
    <ul>
        <li><a href="#recurring-invoices">How do recurring invoices work?</a></li>
        <li><a href="#create-recurring-invoice">How do I create a recurring invoice?</a></li>
        <li><a href="#copy-recurring-invoice">How do I copy a recurring invoice?</a></li>
    </ul>
    ...
    <p>Once a recurring invoice has been created, the <a href="{{ url('en/2.0/getting-started/task-scheduler') }}">Task Scheduler</a>
        will cycle through each day and check for any recurring invoices which are due to generate invoices
        from. Any recurring invoices which are
    ...
    <p style="font-style: italic;">* Note the <a href="{{ url('en/2.0/getting-started/task-scheduler') }}">Task Scheduler</a> needs
    ...
    <a href="/content/docs/2.0/recurring_invoice_create.png" target="_blank">
        <img src="/content/docs/2.0/recurring_invoice_create_small.png" class="img-responsive">
    </a>

    <p>The Create Recurring Invoice screen will prompt you for the client name, company profile, group, start
        date and frequency.</p>
    <p>If the recurring invoice is for a new client, type the client's name in full. You will be able to edit
        the other details
    ...
    <p>The company profile is where the recurring invoice will pull your company name, address, phone number,
        and other company
    ...
    <a href="/content/docs/2.0/recurring_invoice_create2.png" target="_blank">
        <img src="/content/docs/2.0/recurring_invoice_create2_small.png" class="img-responsive">
    </a>
    ...
    <p>Terms and conditions as well as text to appear in the footer of your invoice may be entered on the
        ...
        not appear on recurring invoices
        already created).</p>
    ...
    <ul>
        ...
        <li>Stop Date - If invoices should generate up to a specific date and stop afterward, the stop date can
            be entered.
        </li>
    ...
    <a href="/content/docs/2.0/recurring_invoice_edit.png" target="_blank">
        <img src="/content/docs/2.0/recurring_invoice_edit_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/recurring_invoice_copy.png" target="_blank">
        <img src="/content/docs/2.0/recurring_invoice_copy_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/recurring_invoice_copy2.png" target="_blank">
        <img src="/content/docs/2.0/recurring_invoice_copy2_small.png" class="img-responsive">
    </a>
