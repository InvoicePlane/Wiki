...
@section('content')
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>If using more than one company profile, a default may be set. This default company profile will
                be
        ...
        <tr>
            <td>Version</td>
            <td>The current version of your installation. Pressing the Check for Update button will check to see
                if any
        ...
        <tr>
            <td>Language</td>
            <td>The default system language. The language may also be set per client so they can see their
                quotes, invoices and Client Center
        ...
        <tr>
            ...
            <td>
                <p>If you enter addresses into the individual address fields (Address, City, State, Postal Code, etc),
                    then the Address Format might be entered as such:</p>
        ...
        <tr>
            ...
            <td>If set to Automatic, the exchange rate will automatically adjust itself on a quote or invoice
                when the quote or invoice
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>The number of days after the invoice date which an invoice is due. This value is required and
                must be numeric.
            </td>
            <td>30</td>
        </tr>
        ...
        <tr>
            <td>Default Terms</td>
            <td>Default terms may be entered so they are automatically filled in on newly created invoices.
                Changing
        ...
        <tr>
            ...
            <td>Determines whether payment receipts are automatically emailed when online payments are made.
                Also
        ...
        <tr>
            ...
            <td>When an online payment is made, this is the payment method which will be assigned to the
                payment.
            </td>
            <td></td>
        </tr>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>The number of days after the quote date which a quote expires. This value is required and must
                be numeric.
            </td>
            <td>15</td>
        </tr>
        ...
        <tr>
            ...
            <td>An invoice converted from a quote may either retain the terms which were entered on the quote or
                it may use the default invoice terms.
            </td>
            <td>The invoice should retain the terms from the quote</td>
        </tr>
        <tr>
            <td>Default Terms</td>
            <td>Default terms may be entered so they are automatically filled in on newly created quotes.
                Changing
        ...
        <tr>
            <td><span class="anchor" id="quote-email-while-draft"></span>If Quote is Emailed While in Draft
                Status
            </td>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>A comma separated list of days after an invoice is due to send the reminder. Leave empty to
                disable overdue invoice reminders. For example, a value of 1,5,10 would send reminders 1, 5 and
                10 days after the invoice is due.
            </td>
            <td></td>
        </tr>
        <tr>
            <td>Upcoming Payment Notice Frequency</td>
            <td>A comma separated list of days before an invoice is due to send the reminder. Leave empty to
                disable upcoming payment notices. For example, a value of 1,5 would send notices 1 and 5 days
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>This button will create a full .sql file backup of your InvoicePlane database for download.
            </td>
            <td></td>
        </tr>
    </table>
