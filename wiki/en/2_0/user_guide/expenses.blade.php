...
@section('content')
    ...
    <ul>
        <li><a href="#enter-expense">How do I enter an expense?</a></li>
        <li><a href="#bill-expense">How do I bill an expense to a client?</a></li>
        <li><a href="#profit-loss">How can I see my profit and loss?</a></li>
    </ul>
    ...
    <a href="/content/docs/2.0/expense_create.png" target="_blank">
        <img src="/content/docs/2.0/expense_create_small.png" class="img-responsive">
    </a>

    <p>Adjust the company profile and the date of the expense if needed.</p>
    <p>Enter a category to assign the expense to. If you have previously entered the same category, it will
        appear
        once you start typing.</p>
    <p>Enter the amount of the expense.</p>
    <p>Optionally enter the name of the vendor for the expense. If you have previously entered the same vendor,
        it
        will appear once you start typing.</p>
    <p>If this is a billable expense, enter the name of the client who will reimburse you. This will allow you
        to add this
    ...
    <a href="/content/docs/2.0/expense_create2.png" target="_blank">
        <img src="/content/docs/2.0/expense_create2_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/expense_bill.png" target="_blank">
        <img src="/content/docs/2.0/expense_bill_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/expense_bill2.png" target="_blank">
        <img src="/content/docs/2.0/expense_bill2_small.png" class="img-responsive">
    </a>
    ...
    <a href="/content/docs/2.0/expense_profit_loss.png" target="_blank">
        <img src="/content/docs/2.0/expense_profit_loss_small.png" class="img-responsive">
    </a>
