...
@section('content')
    ...
    <h2 class="page-title">Task Scheduler</h2>

    <ul>
        <li><a href="#what-is-task-scheduler">What is the task scheduler?</a></li>
        <li><a href="#how-to-set-up">How do I set the task scheduler up?</a></li>
    </ul>
    ...
    <ol>
        ...
        <li>When in the crontab editor, enter the following command and save the file:<br>
            <code>0 3 * * * curl http://YourInvoicePlaneURL/tasks/run >> /dev/null 2>&1</code>
    </ol>

    <p>
        If you do not have SSH access and you use Godaddy or a similar company, you should have some type of
        account control panel from which cron jobs can be created. If this is the case but you are unsure of how to
        navigate the control panel to create the cron job then you will need to contact your web host or system
        administrator for
        assistance.
    </p>
