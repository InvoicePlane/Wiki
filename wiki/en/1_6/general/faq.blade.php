    ...
    <div id="faq">
        ...
        <div id="debugmode" class="card">
            ...
            <div class="card-block">
                <p>You have a problem with some errors, you are stuck and need help? We would like to help you but first
                    we need some help from you: error logs.</p>
                <ol>
                    <li>Enable the debug mode by replacing <code>ENABLE_DEBUG=false</code> with
                        <code>ENABLE_DEBUG=true</code> in the <code>/ipconfig.php</code> file.
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                Open the folder <code>/application/logs/</code>, open the log file with the current date
                                and copy the whole content.
                            </li>
                            <li>Take a look at your web server error logs.</li>
                            <li>
                                Open the console of your browser (<a
                                        href="http://webmasters.stackexchange.com/a/77337/20720">tutorial</a>), the
                                error may be logged there.
                            </li>
                        </ul>
                    </li>
                    <li>
                        Save the content of the log files and the output of the browser console to <a
                                href="https://paste.invoiceplane.com/">Paste.InvoicePlane.com</a> and post this link
                        with a detailed description to the <a href="https://community.invoiceplane.com">Community
                            Forums</a>.<br/>You will get further help there.
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div id="error01" class="card">
            ...
            <div class="card-block">
                ...
                <p>
                    If you want to install InvoicePlane in a sub-directory like <code>yourdomain.com/invoices/</code>
                    please follow the instructions for the <a
                            href="{{ url('en/1.5/getting-started/installation#subdir') }}">installation in a
                        subdirectory</a>.
                </p>
            </div>
        </div>
        ...
        <div id="error02" class="card">
            ...
            <div class="card-block">
                <p>
                    ...
                    for the <a href="#debugmode">debug mode</a>
                </p>
            </div>
        </div>
        ...
        <div id="error03" class="card">
            ...
            <div class="card-block">
                ...
                <p>To solve this problem you should try to add / update your nginx configuration with the following
                    settings:</p>
...
fastcgi_busy_buffers_size 256k;</code></pre>
                <p class="small">Please check <a href="http://stackoverflow.com/a/27551259/1203515">this comment</a> for
                    more details.</p>
            </div>
        </div>
        ...
        <div id="settings01" class="card">
            ...
            <div class="card-block">
                <p>You can set the default invoice / quote groups at <code>System settings > Invoices > Default Invoice
                        Group</code> for invoices and <code>System settings > Quotes > Default Quote Group</code> for
                    quotes.</p>
            </div>
        </div>
        ...
        <div id="custom01" class="card">
            ...
            <div class="card-block">
                ...
                <p>The templates are using basic HTML, CSS and PHP. If you just want to change the styling you just need
                    some knowledge of HTML and CSS.<br/>
                    If you want to include Custom Fields into the templates please refer to the <a
                            href="{{ url('en/1.5/settings/custom-fields#add-to-template') }}">Custom Fields page</a>.
                </p>
            </div>
        </div>
