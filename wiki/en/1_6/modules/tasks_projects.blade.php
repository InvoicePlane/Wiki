...
@section('content')
    ...
    <h3 id="projects">
        Projects <?= IP::headlineLink('/en/1.6/modules/tasks_projects#projects'); ?>
    </h3>
    ...
    <h3 id="tasks">
        Tasks <?= IP::headlineLink('/en/1.6/modules/tasks_projects#tasks'); ?>
    </h3>
    ...
    <h4 id="task-status">
        Task Status <?= IP::headlineLink('/en/1.6/modules/tasks_projects#task-status'); ?>
    </h4>
    ...
    <h4 id="tasks-invoices">
        Tasks in Invoices <?= IP::headlineLink('/en/1.6/modules/tasks_projects#tasks-invoices'); ?>
    </h4>
