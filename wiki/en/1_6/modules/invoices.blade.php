...
@section('content')
    ...
    <h3 id="lifecycle">
        The Invoice Lifecycle <?= IP::headlineLink('/en/1.6/modules/invoices#lifecycle'); ?>
    </h3>
    ...
    <h3 id="view">
        Viewing Invoices <?= IP::headlineLink('/en/1.6/modules/quotes#view-quote'); ?>
    </h3>
    ...
    <h3 id="add">
        Creating an Invoice <?= IP::headlineLink('/en/1.6/modules/invoices#add'); ?>
    </h3>
    ...
    <p class="small">* Invoice deletion is not available for all invoices. Please read the information for <a href="{{ url('en/1.6/modules/invoices#delete') }}">invoice deletion</a>.</p>

    <h4 id="add-products">
        Add Products <?= IP::headlineLink('/en/1.6/modules/invoices#add-products'); ?>
    </h4>
    ...
    <h4 id="item-order">
        Changing Item Order <?= IP::headlineLink('/en/1.6/modules/invoices#item-order'); ?>
    </h4>
    ...
    <h4 id="discounts">
        Discounts <?= IP::headlineLink('/en/1.6/modules/invoices#discounts'); ?>
    </h4>
    ...
    <h4 id="add-tax">
        Adding Taxes <?= IP::headlineLink('/en/1.6/modules/invoices#add-tax'); ?>
    </h4>
    ...
    <h4 id="copy">
        Copying an Invoice <?= IP::headlineLink('/en/1.6/modules/invoices#copy'); ?>
    </h4>
    ...
    <h3 id="delete">
        Invoice Deletion <?= IP::headlineLink('/en/1.6/modules/invoices#delete'); ?>
    </h3>
    ...
    <h3 id="read-only">
        Read-only <?= IP::headlineLink('/en/1.6/modules/invoices#read-only'); ?>
    </h3>
    ...
    $article_pagination = array(
            ...
            'next' => array(
                    'url' => '/en/1.6/modules/recurring-invoices',
