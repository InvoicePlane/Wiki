...
@section('content')
    ...
    <h3 id="lifecycle">
        The Quote Lifecycle <?= IP::headlineLink('/en/1.6/modules/quotes#lifecycle'); ?>
    </h3>
    ...
    <h3 id="view-quote">
        Viewing Quotes <?= IP::headlineLink('/en/1.6/modules/quotes#view-quote'); ?>
    </h3>
    ...
    <h3 id="create-quote">
        Creating a Quote <?= IP::headlineLink('/en/1.6/modules/quotes#create-quote'); ?>
    </h3>
    ...
    <h4 id="add-products">
        Adding Products <?= IP::headlineLink('/en/1.6/modules/quotes#add-products'); ?>
    </h4>
    ...
    <h4 id="item-order">
        Changing Item Order <?= IP::headlineLink('/en/1.6/modules/quotes#item-order'); ?>
    </h4>
    ...
    <h4 id="add-tax">
        Add Tax to Quote <?= IP::headlineLink('/en/1.6/modules/quotes#add-tax'); ?>
    </h4>
    ...
    <h4 id="copy-quote">
        Copying the Quote <?= IP::headlineLink('/en/1.6/modules/quotes#copy-quote'); ?>
    </h4>
    ...
    <h4 id="quote-to-invoice">
        Generate Invoice from Quote <?= IP::headlineLink('/en/1.6/modules/quotes#quote-to-invoice'); ?>
    </h4>
