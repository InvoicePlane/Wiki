...
@section('content')
    ...
    <h3 id="install">
        Install a new translation <?= IP::headlineLink('/en/1.0/system/translation-localization#install'); ?>
    </h3>
...
└── ...
    ...
    <h3 id="customize">
        Customize translations <?= IP::headlineLink('/en/1.0/system/translation-localization#customize'); ?>
    </h3>
