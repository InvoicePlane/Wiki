...
RewriteRule . index.php [L]</code></pre>
    ...
    <p>After that, open your <code>ipconfig.php</code> file and add the sub directory to your URL like this:</p>
    ...
    <p>Please notice that this step is entirely optional and does not affect the application in any way.</p>
    ...
    <ol>
        ...
        <li>Search for <code>REMOVE_INDEXPHP=false</code> in this file and replace it with <code>REMOVE_INDEXPHP=true</code></li>
