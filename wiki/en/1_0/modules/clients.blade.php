...
@section('content')
    ...
    <h3 id="view-clients">
        View Clients <?= IP::headlineLink('/en/1.0/modules/clients#view-clients'); ?>
    </h3>
    ...
    <h3 id="add-clients">
        Add new Clients <?= IP::headlineLink('/en/1.0/modules/clients#add-clients'); ?>
    </h3>
    ...
    <h3 id="client-login">
        Client Logins <?= IP::headlineLink('/en/1.0/modules/clients#client-login'); ?>
    </h3>
