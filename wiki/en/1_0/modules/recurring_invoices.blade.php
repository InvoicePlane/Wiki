...
@section('content')
    ...
    <h3 id="requirements">
        Requirements <?= IP::headlineLink('/en/1.0/modules/recurring-invoices#requirements'); ?>
    </h3>

    <p>For recurring invoices to generate properly, you must create a <a href="{{ url('en/1.0/help/setup_cron') }}">CRON job</a> or
    ...
    <p>Replace <code>your-cron-key-here</code> with the generated cron key in <a href="{{ url('en/1.0/settings/general') }}">System
            Settings</a>.</p>

    <h3 id="add-recurring">
        Create a recurring Invoice <?= IP::headlineLink('/en/1.0/modules/recurring-invoices#add-recurring'); ?>
    </h3>
    ...
    <h3 id="view">
        Viewing Recurring Invoices <?= IP::headlineLink('/en/1.0/modules/recurring-invoices#view'); ?>
    </h3>
