    ...
    <div id="faq">
        ...
        <div id="general01" class="card">
            <div class="card-header">
                Can I sell / redistribute InvoicePlane? <?= IP::headlineLink('/en/1.0/general/faq#general01'); ?>
            </div>
        ...
        <div id="debugmode" class="card">
            <div class="card-header">
                You have problems and need help? Use the debug mode. <?= IP::headlineLink('/en/1.0/general/faq#debugmode'); ?>
            </div>
            <div class="card-block">
        ...
        <div id="error01" class="card">
            <div class="card-header">
                I copied InvoicePlane to my webserver but I get blank pages or an error 404 or 500 <?= IP::headlineLink('/en/1.0/general/faq#error01'); ?>
            </div>
            <div class="card-block">
        ...
        <div id="error02" class="card">
            <div class="card-header">
                There is a large spinning cog (<i class="fa fa-cog"></i>) after I clicked a button and now nothing happens <?= IP::headlineLink('/en/1.0/general/faq#error02'); ?>
            </div>
            <div class="card-block">
		...
		<div id="error03" class="card">
            <div class="card-header">
                I can't add more than 3 or 4 items to quotes or invoices <?= IP::headlineLink('/en/1.0/general/faq#error03'); ?>
            </div>
            <div class="card-block">
...
fastcgi_busy_buffers_size 256k;</code></pre>
        ...
        <div id="settings01" class="card">
            <div class="card-header">
                Where can I set the default invoice / quote groups? <?= IP::headlineLink('/en/1.0/general/faq#settings01'); ?>
            </div>
            <div class="card-block">
        ...
        <div id="custom01" class="card">
            <div class="card-header">
                How can I customize the templates? <?= IP::headlineLink('/en/1.0/general/faq#custom01'); ?>
            </div>
            <div class="card-block">
