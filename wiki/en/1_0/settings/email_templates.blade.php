...
@section('content')
    ...
    <h3 id="add">
        Creating an Email Template <?= IP::headlineLink('/en/1.0/settings/email-templates#add'); ?>
    </h3>
    ...
    <h3 id="default-templates">
        Setting Default Email Templates <?= IP::headlineLink('/en/1.0/settings/email-templates#default-templates'); ?>
    </h3>
