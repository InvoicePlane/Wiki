...
@section('content')
    ...
    <h3 id="configure">
        Configure an Invoice Group <?= IP::headlineLink('/en/1.0/settings/invoice-groups#configure'); ?>
    </h3>
    ...
    <h4 id="prefix">
        Format the Identifier <?= IP::headlineLink('/en/1.0/settings/invoice-groups#identifier'); ?>
    </h4>
    ...
    <h4 id="examples">
        Formatting Examples <?= IP::headlineLink('/en/1.0/settings/invoice-groups#examples'); ?>
    </h4>
