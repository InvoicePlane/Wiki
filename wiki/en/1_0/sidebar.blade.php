<li>
    <a href="#" data-toggle="collapse" data-target="#submenu-10-general" class="has-submenu collapsed">
        General information
...
<li>
    <a href="#" data-toggle="collapse" data-target="#submenu-10-getting-started" class="has-submenu collapsed">
        Getting started
        <span class="pull-right"><span class="menu-icon fa fa-fw"></span></span>
    </a>
...
<li>
    <a href="#" data-toggle="collapse" data-target="#submenu-10-modules" class="has-submenu collapsed">
        Modules
        <span class="pull-right"><span class="menu-icon fa fa-fw"></span></span>
    </a>
...
<li>
    <a href="#" data-toggle="collapse" data-target="#submenu-10-settings" class="has-submenu collapsed">
        Settings
        <span class="pull-right"><span class="menu-icon fa fa-fw"></span></span>
    </a>
...
<li>
    <a href="#" data-toggle="collapse" data-target="#submenu-10-templates" class="has-submenu collapsed">
        Templates
        <span class="pull-right"><span class="menu-icon fa fa-fw"></span></span>
    </a>
...
<li>
    <a href="#" data-toggle="collapse" data-target="#submenu-10-system" class="has-submenu collapsed">
        System
        <span class="pull-right"><span class="menu-icon fa fa-fw"></span></span>
    </a>
